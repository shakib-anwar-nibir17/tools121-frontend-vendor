      ...
      <TableBody className="border-b-2 border-slate-200">
        {ProductList.map((product) => (
          ...
          >
            ...
            <TableCell className="w-[10%]">{product.category}</TableCell>
            <TableCell className="w-[12.5%]">{product.stock}</TableCell>
            <TableCell className="w-[12.5%]">{product.price}</TableCell>
